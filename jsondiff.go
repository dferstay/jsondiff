...
func Compare(a, b []byte, opts *Options) (Difference, string) {
	return CompareReaders(bytes.NewReader(a), bytes.NewReader(b), opts)
}

// CompareReaders compares two JSON documents read by the specified readers
func CompareReaders(a, b io.Reader, opts *Options) (Difference, string) {
	var av, bv interface{}
